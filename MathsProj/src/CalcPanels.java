...
//		CalcPanel.add(rdbtnDegrees);
		...
		JButton tandButton = new JButton("tand");
		tandButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				calcInput.setText(calcInput.getText() + "tand");
			}
		});
		tandButton.setBounds(140, 330, 65, 65);
		CalcPanel.add(tandButton);
