...
public class Evaluator  {  
    ...
    static{  
        ...
        OPERATORS.put("/", new int[] { 5, LEFT_ASSOC }); //these are in reverese order of precedence with highest precedence the last one listed          
    ...
    public static String[] infixToRPN(Collection<String> inputTokens){  
        ...
        /*
         * The above code follows the normal algorithm for calculating reverse polish notation. It is quite simple and I don't think
