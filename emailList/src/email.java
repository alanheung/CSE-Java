...
//	}
	...
	@Test
	public void testJoinListSuccess(){
		...
		emailAddress2Field.sendKeys("alan@alan.com");
		//Get the second email address element and set the value
		...
		assertEquals("Thanks for joining", driver.getTitle());
		WebElement heading=driver.findElement(By.tagName("h1"));
		assertEquals("Thanks for joining our email list!", heading.getText());
//		assertEquals("hello", "hello");
	...
	public void testAllFieldsEmpty(){
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		assertEquals("Join Email List", driver.getTitle());
		WebElement errorMsgEmail=driver.findElement(By.id("email_address1_error"));
		assertEquals("This field is required.", errorMsgEmail.getText());
		WebElement errorMsgName=driver.findElement(By.id("first_name_error"));
		assertEquals("This field is required.", errorMsgName.getText());
	}
	
	@Test
	public void testEmailFieldsEmpty(){
		//Get the first email address element and set the value
		WebElement emailAddress1Field = driver.findElement(By.id("email_address1"));
		emailAddress1Field.clear();
	...
	public void testNameFieldEmpty(){
		...
		assertEquals("Join Email List", driver.getTitle());
		WebElement errorMsgEmail=driver.findElement(By.id("email_address1_error"));
		assertEquals("", errorMsgEmail.getText());
		WebElement errorMsgName=driver.findElement(By.id("first_name_error"));
		assertEquals("This field is required", errorMsgName.getText());
	}
