...
public class UserData implements Serializable{
	...
	private static List<User> allUsers = new ArrayList<User>(Arrays.asList(
			new User("Sam Power","23 Hazel Park","0872369852","skyboypower@gmail.com","password","Customer"),
			new User("Aidan Higgins","14 Hodson Bay Road","0860523697","ahig@gmail.com","Password","Delivery Driver"),
			new User("Joe Bloggs","56 Willow Park","0854213698","j.bloggs@gmail.com","Athlone","Stock"),
			new User("Colm Fitzgerald","16 Main Street","0863219687","colm.fitzgerald10@gmail.com","Corrigans","Manager")));
