...
//		System.out.print("Please enter the number of numbers to add: ");
//		int n = sc.nextInt();
//		sumTheValues(n);
	...
	public static void sumTheValues(int n){
		int total=0;
		for(int i=0; i<n; i++){
		...
		System.out.println("The sum of "+n+" values entered is "+total);
	}
	...
	public static void intPower(int base, int exp){ 
	    int result = 1;
	    while (exp > 0) {
	        result = result * base;
	        exp--;
