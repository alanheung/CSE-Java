...
public class UserDetailsTest {
	...
	public void testToString(){
		...
		assertEquals("Name : " + userDetails.getName() + "\tAddress : " + userDetails.getAddress() + "\tTime : " + userDetails.getTime() + "\nOrder : " + 
							userDetails.getOrder() + "\nNote : " + userDetails.getNote(),userDetails.toString());
	}
