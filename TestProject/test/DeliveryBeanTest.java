...
public class DeliveryBeanTest {
	...
	public void testGettersANDSetters(){
		myDeliveryBean.setNotes("Anything");
		myDeliveryBean.setCanEdit(true);
		myDeliveryBean.setDeliveryTime("1pm");
		assertEquals("1pm", myDeliveryBean.getDeliveryTime());
		assertEquals("Anything",myDeliveryBean.getNotes());
