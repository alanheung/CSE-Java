...
public class Assessment3Solution {
	...
	public static void main(String[]args){
		...
		while(userContinue.equalsIgnoreCase("y")){
			...
			case UPDATE: 
				...
				break;
			case DELETE_ONE_CAR: 
				deleteOneCar(preOwnedCars);
				break;
			case DELETE_ALL_CARS: 
				deleteAllCars(preOwnedCars);
				break;
			case FIND_CAR_BY_INDEX: 
				findCarByIndex(preOwnedCars);
				break;
			case DISPLAY: 
				display(preOwnedCars);
				break;
			case EXIT:
				userContinue="n";
				break;
	...
	public static void add(ArrayList<PreOwnedCar> carList){//(String input, ArrayList<PreOwnedCar> carList){//add
...
//	public static void add(String carRegNo, ArrayList<PreOwnedCar> carList){//add
//		carRegNo = carAlreadyThere(carRegNo);
//		System.out.print("Enter make ");
//		String make = sc.next();
//		System.out.print("Enter model ");
//		String model = sc.next();
...
//	}
//
//	public static String carAlreadyThere(String carRegNo){//check if car is already there
//		ArrayList<PreOwnedCar> carList = new ArrayList<>();
//		PreOwnedCar car = new PreOwnedCar();
//		System.out.print("Enter the registration number ");
//		carRegNo = sc.next();
//		boolean exists=false;
//		for(PreOwnedCar car1:carList){
//			if(car1.getRegNo().equalsIgnoreCase(carRegNo)){
...
//	}
	...
	public static void carAlreadyThere(ArrayList<PreOwnedCar> carList){//check if car is already there
		System.out.print("Enter the registration number ");
	...
	public static void update(ArrayList<PreOwnedCar> carList){//update make model reg
	...
	public static void deleteOneCar(ArrayList<PreOwnedCar> carList){//delete one car
		System.out.println("Cars before:"+carList);
	...
	public static void deleteAllCars(ArrayList<PreOwnedCar> carList){// delete all cars
		carList.clear();
		if(carList.isEmpty()){
	...
	public static void findCarByIndex(ArrayList<PreOwnedCar> carList){//find car by index
	...
	public static void display(ArrayList<PreOwnedCar> carList){//display
		for(PreOwnedCar car:carList){
