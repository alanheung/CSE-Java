...
//	public static void add(ArrayList<PreOwnedCar> carList){//add
//		System.out.print("Enter the registration number ");
//		String carRegNo = sc.next();
//		boolean exists=carAlreadythere();
//		if(exists==false){
...
//	}
//
//	public static boolean carAlreadyThere(String carRegNo){//check if car is already there
