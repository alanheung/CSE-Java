...
<h:form>
  ...
  <h:panelGrid headerClass="page-header" styleClass="table-background"
    ...
    <h:panelGrid columns="5"
      ...
      <h:outputText value="Business Analyst"/>
      <h:commandLink action="details">
        <h:outputText value="Details"/>
      </h:commandLink>

      <h:outputText value="Client Portal v3.5"/>
      <h:outputText value="External Web Application"/>
      <h:outputText value="Final Development"/>
      ...
      <h:outputText value="Asset Manager 5.6"/>
      <h:outputText value="External Desktop Application"/>
