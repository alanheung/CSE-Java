...
<html>
<head>
<title>JSF in Action - RolloverButtonDecorator Custom Renderer</title>
  <style>
  .foo { padding: 5px; background-color: #C1C1FF; }
  </style>
</head>
<body bgcolor="#ffffff">
<h1>RolloverButtonDecorator Renderer</h1>
<f:view>
  <h:form>
      <h:panelGrid cellspacing="10">
       <jia:commandRolloverButtonDecorator action="#{testForm.incrementCounter}"
                                   value="Reset" alt="Submit" title="Submit"
                                    type="reset"/>

      <jia:commandRolloverButtonDecorator actionListener="#{testForm.incrementCounter}"
