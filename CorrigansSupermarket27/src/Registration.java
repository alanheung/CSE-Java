...
public class Registration implements Serializable{
	...
	public Registration(String fullName,String address,String mobileNumber,String emailAddress,String password,String userType){
	...
	public boolean getMobileNumberEmpty() {
	...
	public String isAddressEmpty(){
		addressEmpty=(address==null || address.equals(""));
		return null;
	}
	
	public String isMobileNumberEmpty(){
		mobileNumberEmpty=(mobileNumber==null || mobileNumber.equals(""));
		return null;
	}
	...
	public String validPersonalDetails(){
		...
		isAddressEmpty();
		isMobileNumberEmpty();
		step1Valid=(!fullNameEmpty&&!emailEmpty&&!addressEmpty&&!mobileNumberEmpty);
		return null;
	}
	...
	public String checkManagerToRedirectToHomeOrManagerHome(){
		LoginBean currentuser = new LoginBean();
		if(currentuser.getCurrentUser().getUserType().equals("Manager")){
	...
	public String addRegisteredCustomerOrEmployee(){
		User newUser = new User(this.fullName,this.address,this.mobileNumber,this.email,this.password,this.userType);
