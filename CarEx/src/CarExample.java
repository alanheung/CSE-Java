...
//		}
		...
		Person george = new Person("George","Waterford", false, false, false, true, false, false, volvo);
		
		george.calculatePenaltyPoints();
		System.out.println(george);

		if(george.isDisqualified() == true){
			System.out.println("George: disqualification status = "+george.isDisqualified());
		}
